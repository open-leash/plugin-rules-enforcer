...
LABEL org.opencontainers.image.title="OpenLeash Rules Enforcer" \
      org.opencontainers.image.source="https://github.com/open-leash/plugin-rules-enforcer" \
      org.opencontainers.image.licenses="Apache-2.0"

WORKDIR /app
COPY plugins/container-runtime/server.mjs ./server.mjs
COPY plugins/plugin-rules-enforcer/dist ./plugin
